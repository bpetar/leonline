/** 
 * \file RTSCamera.h
 * \brief File RTSCamera.h is taken from irrlicht forum. RTS Camera class is created by CmdKewin.
...
class RTSCamera : public ICameraSceneNode
{
   public:
      RTSCamera(IrrlichtDevice* devicepointer,ISceneNode* parent,ISceneManager* smgr,s32 id,
         f32 rotateSpeed = -100.0f,f32 zoomSpeed = 100.0f,f32 translationSpeed = 10.0f);
	  ...
	  void ResetMouseKeys();
	  bool OnUvent(const SEvent& event);
