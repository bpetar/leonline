...
void CEditorLevel::InitLevel()
{
	...
	m_LevelCamera = new RTSCamera(m_EditorManager->getDevice(),m_EditorManager->getSceneMngr()->getRootSceneNode(),m_EditorManager->getSceneMngr(),-1,200.0f,200.0f,400.0f);
